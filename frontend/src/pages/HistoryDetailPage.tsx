...
import { ArrowLeft, Clock3, ImageOff, Tag } from 'lucide-react';
...
export const HistoryDetailPage = () => {
  ...
  return (
    <div className="px-6 py-6 pb-10">
      ...
      {detail && !isLoading ? (
        <div className="mt-6 grid max-w-6xl gap-6 xl:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)]">
          ...
          <div className="space-y-6">
            ...
            <section className="studio-surface p-5">
              ...
              <dl className="mt-3 grid gap-3 text-sm sm:grid-cols-2">
                ...
                <div>
                  <dt className="text-text-secondary">생성자</dt>
